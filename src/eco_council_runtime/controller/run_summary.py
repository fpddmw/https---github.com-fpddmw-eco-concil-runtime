...
def stage_label_zh(stage: str) -> str:
    return {
        ...
        STAGE_AWAITING_INVESTIGATION_REVIEW: "等待议长提交因果链审查",
        STAGE_READY_MATCHING_ADJUDICATION: "等待物化匹配裁定并生成因果链审查包",
    ...
    def stage_label(stage: str) -> str:
        if lang == "en":
            return {
                ...
                STAGE_AWAITING_INVESTIGATION_REVIEW: "Waiting for moderator investigation review",
                STAGE_READY_MATCHING_ADJUDICATION: "Waiting to materialize the adjudication and generate investigation-review packets",
