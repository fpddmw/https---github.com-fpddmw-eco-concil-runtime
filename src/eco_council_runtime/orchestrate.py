...
def build_reporting_handoff(*, run_dir: Path, round_id: str) -> Path:
    ...
    handoff = {
        ...
        "investigation_review_prompt_path": existing_path(base_round_dir / "moderator" / "derived" / "openclaw_investigation_review_prompt.txt"),
        ...
        "canonical_paths": {
            ...
            "investigation_review": existing_path(base_round_dir / "moderator" / "investigation_review.json"),
        ...
        "draft_paths": {
            ...
            "investigation_review": existing_path(base_round_dir / "moderator" / "derived" / "investigation_review_draft.json"),
