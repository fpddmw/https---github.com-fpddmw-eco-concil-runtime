#!/usr/bin/env python3
"""Normalize gdelt-events-fetch exports into row-level public signal-plane rows."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize gdelt-events-fetch exports into row-level public signal-plane rows.")
