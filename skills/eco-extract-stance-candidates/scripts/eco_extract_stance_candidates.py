#!/usr/bin/env python3
"""Derive canonical stance-group objects from canonical issue-cluster rows."""
...
SKILL_NAME = "eco-extract-stance-candidates"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Derive canonical stance-group objects from canonical issue-cluster rows."
    )
