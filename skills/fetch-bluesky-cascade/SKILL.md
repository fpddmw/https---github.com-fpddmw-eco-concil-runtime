...
```bash
python3 scripts/fetch_bluesky_cascade.py check-config --pretty
```

2. Dry-run the fetch plan first.

```bash
python3 scripts/fetch_bluesky_cascade.py fetch \
  --source-mode search \
