...
from eco_council_runtime.kernel.planes.gdelt_export_normalizer import (  # noqa: E402
    ...
    return base_signal(
        ...
        metadata={
            ...
            "action_geo": {
                ...
                "adm2_code": field_text(columns, "ActionGeo_ADM2Code"),
