#!/usr/bin/env python3
"""Normalize fetch-bluesky-cascade artifacts into a local signal-plane SQLite file."""
...
SKILL_NAME = "normalize-bluesky-cascade-public-signals"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize fetch-bluesky-cascade artifacts into a local signal-plane SQLite file.")
