---
name: eco-open-investigation-round
...
- Materialize `round_tasks_<round_id>.json` so the next round can immediately continue through `eco-prepare-round` or agent-led investigation.
...
## Scripts
- `scripts/eco_open_investigation_round.py`
