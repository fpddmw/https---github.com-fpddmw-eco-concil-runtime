#!/usr/bin/env python3
"""Normalize gdelt-mentions-fetch exports into row-level public signal-plane rows."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize gdelt-mentions-fetch exports into row-level public signal-plane rows.")
