---
name: eco-normalize-gdelt-mentions-public-signals
description: Normalize gdelt-mentions-fetch export snapshots into unified public signals and write them into the signal plane database. Use when tasks need row-level GDELT mention evidence, artifact refs, and board-ready hints from zipped export files.
---

# Eco Normalize GDELT Mentions Public Signals

## Core Goal
- Read one `gdelt-mentions-fetch` manifest artifact plus referenced zip exports.
