#!/usr/bin/env python3
"""Normalize fetch-youtube-video-search artifacts into a local signal-plane SQLite file."""
...
SKILL_NAME = "normalize-youtube-video-public-signals"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize fetch-youtube-video-search artifacts into a local signal-plane SQLite file.")
