...
```bash
python3 scripts/fetch_gdelt_mentions.py check-config --pretty
```

2. Inspect the latest available mentions snapshot.

```bash
python3 scripts/fetch_gdelt_mentions.py resolve-latest --pretty
```
