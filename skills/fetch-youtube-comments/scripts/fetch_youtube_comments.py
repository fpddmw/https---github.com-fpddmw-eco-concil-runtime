...
DEFAULT_USER_AGENT = "fetch-youtube-comments/1.0"
...
def build_logger(level: str, log_file: str) -> logging.Logger:
    logger = logging.getLogger("fetch-youtube-comments")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    fetch.add_argument(
        ...
        help=(
            ...
            "Also accepts fetch-youtube-video-search JSON/JSONL outputs."
        ),
    )
    fetch.add_argument(
        "--dedupe",
