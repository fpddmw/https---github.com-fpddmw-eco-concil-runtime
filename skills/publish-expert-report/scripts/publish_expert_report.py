...
def publish_expert_report_skill(
    ...
    if not isinstance(draft_payload, dict):
        ...
        return {
            ...
            "canonical_ids": [],
            "warnings": warnings,
            "board_handoff": {"candidate_ids": [], "evidence_refs": [], "gap_hints": [warnings[0]["message"]], "challenge_hints": [], "suggested_next_skills": ["draft-expert-report"]},
        }
    ...
    if warnings:
        return {
            ...
            "canonical_ids": [],
            "warnings": warnings,
            "board_handoff": {"candidate_ids": [], "evidence_refs": [], "gap_hints": [item["message"] for item in warnings], "challenge_hints": [], "suggested_next_skills": ["draft-expert-report"]},
        }
    ...
    if isinstance(existing, dict):
        if existing == canonical_payload:
            ...
            return {
                ...
                "warnings": warnings,
                "board_handoff": {"candidate_ids": [maybe_text(draft_payload.get("report_id"))] if maybe_text(draft_payload.get("report_id")) else [], "evidence_refs": [], "gap_hints": [warnings[0]["message"]], "challenge_hints": [], "suggested_next_skills": ["publish-expert-report"]},
            }
