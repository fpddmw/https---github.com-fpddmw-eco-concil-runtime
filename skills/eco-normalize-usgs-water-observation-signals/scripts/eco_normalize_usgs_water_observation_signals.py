#!/usr/bin/env python3
"""Normalize usgs-water-iv-fetch artifacts into environment signal-plane rows."""
...
SKILL_NAME = "eco-normalize-usgs-water-observation-signals"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize usgs-water-iv-fetch artifacts into environment signal-plane rows.")
