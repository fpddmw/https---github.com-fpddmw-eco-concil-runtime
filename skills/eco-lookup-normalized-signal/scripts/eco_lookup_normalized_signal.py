...
def lookup_normalized_signal_skill(run_dir: str, signal_id: str, db_path: str, include_raw_json: bool) -> dict[str, Any]:
    ...
    if row is None:
        return {
            ...
            "board_handoff": {"candidate_ids": [], "evidence_refs": [], "gap_hints": ["No normalized signal was found for the requested id."], "challenge_hints": [], "suggested_next_skills": ["eco-query-public-signals", "eco-query-environment-signals"]},
        }
    ...
    return {
        ...
        "artifact_refs": [ref],
        "warnings": [],
        "board_handoff": {"candidate_ids": [signal_id], "evidence_refs": [ref], "gap_hints": [], "challenge_hints": [], "suggested_next_skills": ["eco-lookup-raw-record"]},
    }
