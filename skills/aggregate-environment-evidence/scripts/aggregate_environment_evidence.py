#!/usr/bin/env python3
"""Run the WP4 environment evidence aggregation helper."""
...
from eco_council_runtime.wp4_helpers import pretty_json, run_aggregate_environment_evidence  # noqa: E402
