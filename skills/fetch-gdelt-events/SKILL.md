...
```bash
python3 scripts/fetch_gdelt_events.py check-config --pretty
```

2. Inspect the latest available events snapshot.

```bash
python3 scripts/fetch_gdelt_events.py resolve-latest --pretty
```
