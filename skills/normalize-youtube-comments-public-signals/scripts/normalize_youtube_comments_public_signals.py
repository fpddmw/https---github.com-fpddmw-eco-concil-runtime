#!/usr/bin/env python3
"""Normalize fetch-youtube-comments artifacts into public signal-plane rows."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize fetch-youtube-comments artifacts into public signal-plane rows.")
