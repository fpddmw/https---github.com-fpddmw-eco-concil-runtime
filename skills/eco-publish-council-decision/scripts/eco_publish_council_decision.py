...
def publish_council_decision_skill(
    ...
    return {
        ...
        "board_handoff": {
            ...
            "gap_hints": [],
            "challenge_hints": [],
            "suggested_next_skills": ["eco-post-board-note"] if publication_readiness == "ready" else ["eco-post-board-note", "eco-propose-next-actions", "eco-open-falsification-probe"],
        },
    }
