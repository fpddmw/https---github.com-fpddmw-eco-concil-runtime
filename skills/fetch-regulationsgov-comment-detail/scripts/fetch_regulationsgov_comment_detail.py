...
DEFAULT_USER_AGENT = "fetch-regulationsgov-comment-detail/1.0"
...
def build_logger(level: str, log_file: str) -> logging.Logger:
    logger = logging.getLogger("fetch-regulationsgov-comment-detail")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    fetch.add_argument(
        "--output-dir",
        default="./runs/manual-fetch-artifacts/regulationsgov-comment-details",
