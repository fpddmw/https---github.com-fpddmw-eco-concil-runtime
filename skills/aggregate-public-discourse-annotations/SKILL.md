...
## Core Goal
- Read a DB-backed public discourse corpus and approved taxonomy cues or agent-authored annotation JSON/JSONL.
...
- Optionally reads approved taxonomy label cues or agent-authored annotation JSON/JSONL with an annotation basis ref
