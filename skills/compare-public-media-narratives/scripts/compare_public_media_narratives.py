#!/usr/bin/env python3
"""Run the optional-analysis public/media narrative comparison helper."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare sampled public and media narratives.")
    ...
    payload = run_compare_public_media_narratives(
