#!/usr/bin/env python3
"""Run the Optional-analysis formal/public footprint helper."""
...
from eco_council_runtime.optional_analysis_helpers import pretty_json, run_compare_formal_public_footprints  # noqa: E402
