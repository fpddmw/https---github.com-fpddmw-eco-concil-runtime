#!/usr/bin/env python3
"""Normalize fetch-nasa-firms-fire artifacts into environment signal-plane rows."""
...
SKILL_NAME = "normalize-nasa-firms-fire-observation-signals"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize fetch-nasa-firms-fire artifacts into environment signal-plane rows.")
