...
```bash
python3 scripts/fetch_open_meteo_flood.py check-config --pretty
```

2. Dry-run the request plan first.

```bash
python3 scripts/fetch_open_meteo_flood.py fetch \
