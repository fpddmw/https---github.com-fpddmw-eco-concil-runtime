#!/usr/bin/env python3
"""Derive canonical evidence-citation-type objects from canonical issue-cluster rows."""
...
SKILL_NAME = "eco-extract-evidence-citation-types"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Derive canonical evidence-citation-type objects from canonical issue-cluster rows."
    )
