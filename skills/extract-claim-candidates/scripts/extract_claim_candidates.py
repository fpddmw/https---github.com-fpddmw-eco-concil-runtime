#!/usr/bin/env python3
"""Extract optional public narrative seed candidates from local signal-plane storage."""
...
SKILL_NAME = "extract-claim-candidates"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract optional public narrative seed candidates from local signal-plane storage.")
