...
from eco_council_runtime.kernel.core.registry import resolve_skill_script  # noqa: E402
...
def materialize_history_context_skill(
    ...
    run_json_script(
        query_script_path("query-case-library"),
        "--run-dir",
        str(run_dir_path),
        "--run-id",
        run_id,
    ...
    run_json_script(
        query_script_path("query-signal-corpus"),
        "--run-dir",
        str(run_dir_path),
        "--run-id",
        run_id,
