#!/usr/bin/env python3
"""Normalize open-meteo-flood-fetch artifacts into environment signal-plane rows."""
...
SKILL_NAME = "eco-normalize-open-meteo-flood-signals"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize open-meteo-flood-fetch artifacts into environment signal-plane rows.")
