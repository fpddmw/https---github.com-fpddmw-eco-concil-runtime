#!/usr/bin/env python3
"""Derive canonical actor-profile objects from canonical issue-cluster rows."""
...
SKILL_NAME = "eco-extract-actor-profiles"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Derive canonical actor-profile objects from canonical issue-cluster rows."
    )
