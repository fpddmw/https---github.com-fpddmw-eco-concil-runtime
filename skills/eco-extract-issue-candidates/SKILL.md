---
name: eco-extract-issue-candidates
...
- Need an issue-candidate view before `eco-cluster-issue-candidates` merges related claims.
...
## Scripts
- `scripts/eco_extract_issue_candidates.py`
