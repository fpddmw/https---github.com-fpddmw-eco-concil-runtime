...
DECOMPOSITION_TARGETS: dict[str, str] = {
    ...
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/benchmark/__init__.py": "P8 benchmark package facade",
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/benchmark/manifest.py": "P8 benchmark manifest pipeline",
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/benchmark/common.py": "P8 benchmark artifact digest support",
    "eco-concil-runtime/src/eco_council_runtime/kernel/governance/skill_approvals/__init__.py": "P7/P7.7 skill approval package facade",
    "eco-concil-runtime/src/eco_council_runtime/kernel/execution/controller/__init__.py": "P7 controller split",
    "eco-concil-runtime/src/eco_council_runtime/kernel/governance/transition_requests/__init__.py": "P7/P7.7 transition request package facade",
    "eco-concil-runtime/src/eco_council_runtime/kernel/governance/agent_entry/__init__.py": "P7.7 agent entry package facade",
    "eco-concil-runtime/src/eco_council_runtime/kernel/governance/fallback/agenda.py": "P7.7 fallback package consolidation",
    ...
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/post_round/__init__.py": "P8 post-round package facade",
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/post_round/common.py": "P8 post-round common state support",
    "eco-concil-runtime/src/eco_council_runtime/kernel/archive/post_round/close.py": "P8 post-round close workflow",
}
