...
```bash
python3 eco-concil-runtime/scripts/eco_milestone_package.py --output-dir /home/fpddmw/projects/openclaw-eco-concil_v1/reports/2026-04-06-milestone-package
```
...
```bash
python3 eco-concil-runtime/scripts/eco_progress_dashboard.py --pretty
python3 eco-concil-runtime/scripts/eco_milestone_package.py --output-dir /home/fpddmw/projects/openclaw-eco-concil_v1/reports/2026-04-06-milestone-package --pretty
