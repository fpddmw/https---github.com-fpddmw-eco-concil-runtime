    ...
    *,
    ...
    for definition in effective_role_definitions:
        ...
        for skill_name in definition.get("write_skills", []) if isinstance(definition.get("write_skills"), list) else []:
                ...
                role_write_commands.append(
                    run_skill_command(
                        ...
                        skill_args=[
                            ...
                            role,
                            "--round-mode",
                            "<framing-scope-council|evidence-acquisition-council|evidence-analysis-council|semantic-analysis-council|interaction-synthesis-council|policy-basis-review-council|supplemental-issue-council|report-writing>",
                            "--round-category",
                            "<planning|evidence-acquisition|evidence-analysis|semantic-analysis|interaction-synthesis|policy-basis-review|supplemental-issue-deliberation|reporting>",
            ...
            elif skill_name == "submit-evidence-route-assessment":
                role_write_commands.append(
                    run_skill_command(
                        run_dir=run_dir,
                        run_id=run_id,
                        ...
                        skill_args=[
                            ...
                            "<what_the_evidence_request_needs>",
                            "--current-surface-summary",
                            "<what_current_sources_or_skills_can_and_cannot_answer>",
                            "--route-judgment",
                            "<route_judgment>",
                            "--source-surface-status",
                            "<insufficient-current-surface|wrong-source-family|needs-followup-skill|external-capability-gap>",
                            "--recommended-next-step",
                            "<route-discovery-continuation|capability-gap-human-pause|bounded-report-with-limitation|revise-request>",
                            "--target-kind",
                            "<evidence-request|source-acquisition-proposal|challenge|round>",
                            "--target-id",
                            "<target_id>",
                            "--target-evidence-request-id",
                            "<evidence_request_id>",
                            "--considered-source-skill",
                            "<source_skill_considered>",
                            "--alternate-route",
                            "<agent_owned_alternate_route_or_empty>",
                            "--rationale",
                            "<rationale>",
                            "--provenance-json",
                            "{\"source\":\"<provenance_source>\"}",
...
def default_agent_entry_operator_commands(
    *,
    ...
    return {
        ...
        "query_evidence_route_assessments_command": query_coordination_object_command(
            run_dir=run_dir,
            run_id=run_id,
            round_id=round_id,
