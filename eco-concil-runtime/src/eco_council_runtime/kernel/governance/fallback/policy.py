    ...
    *,
    ...
    if lane == "formal-comment-and-policy-record" and link_status == "public-only":
        return {
            ...
            "objective": f"Check whether the formal record captures a usable policy-record view of {issue_label}.",
    ...
    if lane == "public-discourse-analysis" and link_status == "formal-only":
        return {
            ...
            "priority": "high",
            "assigned_role": "social-investigator",
            "objective": f"Check whether public discourse around {issue_label} has explicit sample boundaries and interpretable cues.",
            ...
            "recommended_lane": lane,
            "expected_outcome": "Decide whether discourse-side evidence has sample-local boundaries and cue definitions clear enough for council uptake.",
            "probe_candidate": True,
            "contradiction_link_count": 0,
            "coverage_score": 1.0,
            "confidence": None,
    ...
    *,
    ...
    if lane == "formal-comment-and-policy-record" and link_status == "public-only":
        return {
            ...
            "controversy_gap": "formal-record-gap",
            "recommended_lane": lane,
            "expected_outcome": "Decide whether formal record material captures a bounded policy-record view of the issue.",
            "probe_candidate": True,
            "contradiction_link_count": 0,
            "coverage_score": 1.0,
            "confidence": maybe_number(route.get("confidence")),
    ...
    if lane in {"public-discourse-analysis", "stakeholder-deliberation-analysis"} and link_status == "formal-only":
        ...
        return {
            ...
            "priority": "high",
            "assigned_role": "social-investigator",
            "objective": f"Review the discourse-side sample boundary and interpretation posture for {issue_label}.",
            "reason": maybe_text(route.get("route_reason"))
            or f"Claim {claim_id or issue_label} stays in discourse-side review but linkage posture is {link_status}.",
            "controversy_gap": controversy_gap,
            "recommended_lane": lane,
            "expected_outcome": "Decide whether discourse or stakeholder material is bounded and interpretable enough for council uptake.",
            "probe_candidate": True,
            "contradiction_link_count": 0,
            "coverage_score": 1.0,
            "confidence": maybe_number(route.get("confidence")),
