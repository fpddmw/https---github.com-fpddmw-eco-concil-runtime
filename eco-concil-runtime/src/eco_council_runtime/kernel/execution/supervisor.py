    ...
    *,
    ...
    try:
        ...
        payload = {
            ...
            "adopted_transition_request_id": maybe_text(controller.get("adopted_transition_request_id")),
            "adopted_transition_request_status": maybe_text(controller.get("adopted_transition_request_status")),
            "adopted_transition_kind": maybe_text(controller.get("adopted_transition_kind")),
