...
EXACT_PROFILES: dict[str, dict[str, object]] = {
    ...
    "eco-classify-claim-verifiability": _profile(
        ...
        downstream_hints=["eco-route-verification-lane", "eco-materialize-controversy-map"],
    ),
    "eco-route-verification-lane": _profile(
        ...
        downstream_hints=["eco-materialize-controversy-map", "eco-post-board-note"],
    ),
    "eco-materialize-controversy-map": _profile(
        ...
        default_invocation="planned-step",
        core_queue_default=True,
        notes="Materialize a lane-aware issue map so the council can branch by controversy posture instead of following one fixed evidence recipe.",
