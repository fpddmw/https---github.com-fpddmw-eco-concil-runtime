...
ANALYSIS_KIND_CONFIGS: dict[str, dict[str, Any]] = {
    ANALYSIS_KIND_ISSUE_CLUSTER: {
        ...
        "default_source_skill": "eco-cluster-issue-candidates",
        "summary_fields": [
            "cluster_input_path",
            "claim_scope_path",
            "verifiability_path",
    ...
    ANALYSIS_KIND_STANCE_GROUP: {
        ...
        "default_source_skill": "eco-extract-stance-candidates",
    ...
    ANALYSIS_KIND_CONCERN_FACET: {
        ...
        "default_source_skill": "eco-extract-concern-facets",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
    ...
    ANALYSIS_KIND_ACTOR_PROFILE: {
        ...
        "default_source_skill": "eco-extract-actor-profiles",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
    ...
    ANALYSIS_KIND_EVIDENCE_CITATION_TYPE: {
        ...
        "default_source_skill": "eco-extract-evidence-citation-types",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
