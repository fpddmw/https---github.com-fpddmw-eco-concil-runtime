...
ANALYSIS_KIND_CONFIGS: dict[str, dict[str, Any]] = {
    ANALYSIS_KIND_ISSUE_CLUSTER: {
        ...
        "default_source_skill": "cluster-issue-candidates",
        "summary_fields": [
            "cluster_input_path",
            "claim_scope_path",
            "verifiability_path",
    ...
    ANALYSIS_KIND_STANCE_GROUP: {
        ...
        "default_source_skill": "extract-stance-candidates",
    ...
    ANALYSIS_KIND_CONCERN_FACET: {
        ...
        "default_source_skill": "extract-concern-facets",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
    ...
    ANALYSIS_KIND_ACTOR_PROFILE: {
        ...
        "default_source_skill": "extract-actor-profiles",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
    ...
    ANALYSIS_KIND_EVIDENCE_CITATION_TYPE: {
        ...
        "default_source_skill": "extract-evidence-citation-types",
        "summary_fields": ["issue_clusters_path"],
        "query_basis_fields": [
            "issue_clusters_path",
            "issue_clusters_source",
    ...
    ANALYSIS_KIND_DIFFUSION_EDGE: {
        ...
        "default_source_skill": "detect-cross-platform-diffusion",
    ...
    ANALYSIS_KIND_FORMAL_PUBLIC_LINK: {
        ...
        "default_source_skill": "link-formal-comments-to-public-discourse",
        "summary_fields": [
            "claim_cluster_path",
    ...
    ANALYSIS_KIND_REPRESENTATION_GAP: {
        ...
        "default_source_skill": "identify-representation-gaps",
        "summary_fields": ["formal_public_links_path"],
        "query_basis_fields": [
            "formal_public_links_path",
            "formal_public_links_source",
    ...
    ANALYSIS_KIND_CONTROVERSY_MAP: {
        ...
        "default_source_skill": "materialize-controversy-map",
        "summary_fields": [
            "issue_clusters_path",
            "stance_groups_path",
            "concern_facets_path",
    ...
    ANALYSIS_KIND_VERIFICATION_ROUTE: {
        ...
        "default_source_skill": "route-verification-lane",
    ...
    ANALYSIS_KIND_CLAIM_VERIFIABILITY: {
        ...
        "default_source_skill": "classify-claim-verifiability",
        "summary_fields": ["input_path"],
        "query_basis_fields": ["input_path", "input_source"],
        "parent_artifact_fields": ["input_path"],
    ...
    ANALYSIS_KIND_EVIDENCE_COVERAGE: {
        ...
        "default_source_skill": "score-evidence-coverage",
        "summary_fields": [
            "links_path",
            "claim_scope_path",
    ...
    ANALYSIS_KIND_CLAIM_SCOPE: {
        ...
        "default_source_skill": "derive-claim-scope",
        "summary_fields": ["input_path"],
    ...
    ANALYSIS_KIND_OBSERVATION_SCOPE: {
        ...
        "default_source_skill": "derive-observation-scope",
        "summary_fields": ["input_path"],
        "query_basis_fields": ["input_path"],
        "parent_artifact_fields": ["input_path"],
    ...
    ANALYSIS_KIND_CLAIM_OBSERVATION_LINK: {
        ...
        "default_source_skill": "link-claims-to-observations",
    ...
    ANALYSIS_KIND_CLAIM_CLUSTER: {
        ...
        "default_source_skill": "cluster-claim-candidates",
        "summary_fields": ["input_path"],
        "query_basis_fields": ["input_path"],
        "parent_artifact_fields": ["input_path"],
    ...
    ANALYSIS_KIND_MERGED_OBSERVATION: {
        ...
        "default_source_skill": "merge-observation-candidates",
        "summary_fields": ["input_path"],
        "query_basis_fields": ["input_path"],
        "parent_artifact_fields": ["input_path"],
    ...
    ANALYSIS_KIND_CLAIM_CANDIDATE: {
        ...
        "default_source_skill": "extract-claim-candidates",
        "summary_fields": [],
    ...
    ANALYSIS_KIND_OBSERVATION_CANDIDATE: {
        ...
        "default_source_skill": "extract-observation-candidates",
        "summary_fields": [],
