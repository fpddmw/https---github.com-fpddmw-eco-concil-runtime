...
def build_parser() -> argparse.ArgumentParser:
    ...
    post_review_cmd.add_argument("--constraint-disposition", default="")
    ...
    submit_section_cmd.add_argument("--claim-id", default="")
    submit_section_cmd.add_argument("--claim-text", default="")
    submit_section_cmd.add_argument("--claim-constraint-id", action="append", default=[])
    submit_section_cmd.add_argument("--basis-use", default="")
    submit_section_cmd.add_argument("--lead-basis", action="store_true")
