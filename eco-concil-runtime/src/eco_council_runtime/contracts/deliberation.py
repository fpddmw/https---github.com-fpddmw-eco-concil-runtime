...
DELIBERATION_CONTRACTS: dict[str, CanonicalContract] = {
    ...
    "report-outcome-contract": _contract(
        "report-outcome-contract",
        plane=PLANE_DELIBERATION,
        schema_version="report-outcome-contract-v1",
    ...
    "council-investigation-program": _contract(
        "council-investigation-program",
        plane=PLANE_DELIBERATION,
        schema_version="council-investigation-program-v1",
        id_field="program_id",
        required_text_fields=(
            "object_kind",
            "decision_source",
    ...
    "dossier-program": _contract(
        "dossier-program",
        plane=PLANE_DELIBERATION,
        schema_version="dossier-program-v1",
        id_field="program_id",
        required_text_fields=(
            "object_kind",
            "decision_source",
            ...
            "program_id",
            "mission_question",
            "report_outcome_contract_ref",
            "source_autonomy_boundary",
            "final_report_consumption_boundary",
            "adoption_status",
        ),
        required_list_fields=(
            "evidence_refs",
    ...
    "theme-evidence-boundary-plan": _contract(
        "theme-evidence-boundary-plan",
        plane=PLANE_DELIBERATION,
        schema_version="theme-evidence-boundary-plan-v1",
        id_field="plan_id",
        required_text_fields=(
            "object_kind",
            "decision_source",
