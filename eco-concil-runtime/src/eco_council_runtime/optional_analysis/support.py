...
OPTIONAL_ANALYSIS_RULE_IDS: dict[str, str] = {
    ...
    "build-fact-policy-public-interaction-timeline": "HEUR-FACT-POLICY-PUBLIC-TIMELINE-001",
...
def row_to_signal(row: sqlite3.Row) -> dict[str, Any]:
    ...
    return {
        ...
        "external_id": maybe_text(row["external_id"]),
        "dedupe_key": maybe_text(row["dedupe_key"]),
        ...
        "language": maybe_text(row["language"]),
