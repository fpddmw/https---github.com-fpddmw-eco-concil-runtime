...
LIST_ARG_FLAGS = {
    ...
    "report_questions": "report-question",
    "claim_slots": "claim-slot",
    "required_evidence_families": "required-evidence-family",
    "forbidden_claims_without_basis": "forbidden-claim-without-basis",
    "expected_sections": "expected-section",
    "claim_slots_supported": "claim-slot-supported",
    "agent_position_refs": "agent-position-ref",
    "program_questions": "program-question",
    "council_agenda_questions": "council-agenda-question",
    "agent_responsibility_boundaries": "agent-responsibility-boundary",
    "round_internal_phase_model": "round-internal-phase-model",
    "round_exit_criteria": "round-exit-criterion",
    "downgrade_conditions": "downgrade-condition",
    "supplemental_round_triggers": "supplemental-round-trigger",
    "forbidden_scheduler_fields": "forbidden-scheduler-field",
    "active_theme_ids": "active-theme-id",
    "round_internal_phases": "round-internal-phase",
    "expected_council_objects": "expected-council-object",
    "in_round_feedback_triggers": "in-round-feedback-trigger",
    "forbidden_source_precommitments": "forbidden-source-precommitment",
    "program_ids": "program-id-ref",
    "theme_progress_review_ids": "theme-progress-review-id",
    "theme_evidence_boundary_plan_ids": "theme-evidence-boundary-plan-id",
    "expected_artifacts": "expected-artifact",
    "completion_criteria": "completion-criterion",
    "evidence_obligations": "evidence-obligation",
    "success_criteria": "success-criterion",
    "denominator_obligations": "denominator-obligation",
    "forbidden_precommitments": "forbidden-precommitment",
    "source_family_candidates": "source-family-candidate",
    "query_variant_plan": "query-variant-plan",
    "expected_denominators": "expected-denominator",
    "failure_recovery_plan": "failure-recovery-plan",
}
