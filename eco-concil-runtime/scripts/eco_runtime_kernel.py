...
if __name__ == "__main__":
    raise SystemExit(
        main(
            default_gate_handlers=runtime_gate_handler_registry(),
            default_agent_entry_profile=default_agent_entry_profile(),
            default_posture_profile=default_runtime_posture_profile(),
            hard_gate_command_builder=default_agent_entry_hard_gate_commands,
            entry_chain_builder=default_agent_entry_chain,
            default_planning_sources=default_runtime_planning_sources(),
            default_stage_definitions=DEFAULT_RUNTIME_STAGE_DEFINITIONS,
        )
    )
